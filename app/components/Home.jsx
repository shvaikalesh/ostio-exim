...
export default () => {
  return (
    <div>
      ...
      <p>Ost.io (<q>open-source talks</q>) is a forum for open-source projects and the best place for discussing project stuff with other users. It is tightly integrated with <a href="https://github.com/">GitHub</a>.</p>
      ...
      <p>To start, click on <q>Sign in with GitHub</q> button at the top. You'll be redirected to your account then. If you want to sync your repositories, press the button on your profile or profile of any of your organization. When logged in, you're able to create any thread &amp; post in any repo. If you want to receive email notifications on new posts in your repos and in threads you've commented in, you can enable them in <Link to="/settings">settings</Link>.</p>
      ...
      <ul>
        <li><Link to="/@brunch/brunch">Brunch</Link> &mdash; lightweight build tool for HTML5 apps.</li>
        <li><Link to="/@chaplinjs/chaplin">Chaplin</Link> &mdash; app framework on top of Backbone.js.</li>
        <li><Link to="/@gkz/LiveScript">LiveScript</Link> &mdash; more functional-programming oriented CoffeeScript fork.</li>
        <li><Link to="/@Codeception/Codeception">Codeception</Link> &mdash; full-stack testing PHP framework.</li>
      </ul>
